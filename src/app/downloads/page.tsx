...
export default function DownloadsPage() {
  return (
    <EcosystemModuleStub
      ...
      description={DESC}
      path={ecosystemRoutes.downloads}
      body="Здесь появятся официальные ссылки на установочные файлы модулей (Android, компьютер). Сейчас AION Driver устанавливается по ссылке со страницы релизов."
    />
  );
}
