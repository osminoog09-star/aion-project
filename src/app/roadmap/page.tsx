...
const PHASES: {
...
}[] = [
  {
    ...
    status: "done",
    items: [
      { t: "Карта на OpenStreetMap — не пустая, устойчива и без интернета", done: true },
      { t: "Орбита вырезана из сборки — больше не крашит при сворачивании", done: true },
      { t: "Убраны краши голоса и карты, все фейковые данные", done: true },
      { t: "Кнопки смены/дохода/топлива не залипают; ложная карточка обновления убрана", done: true },
      { t: "Старт сразу в кокпите; балласт (модули, desktop, Link, ИИ-центр) скрыт", done: true },
    ],
    done: "Код готов и собран в APK 1.1.4. Финальная проверка 6 экранов на телефоне — за владельцем.",
  },
  {
    n: "1",
    ...
    status: "in_progress",
    items: [
      { t: "Надёжное сохранение: доход и топливо не теряются при kill и потере связи", done: true },
      { t: "Смена: старт / пауза / конец с восстановлением после сна" },
